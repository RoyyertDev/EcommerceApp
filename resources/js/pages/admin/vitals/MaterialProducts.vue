...
<template>
    <DivVitals title="Materiales de productos">
        <template #head>
        ...
        <template #tBody>
            <tr
                v-for="materialProduct in materialProducts"
            ...
            >
                ...
                <td class="">{{ materialProduct.name }}</td>
