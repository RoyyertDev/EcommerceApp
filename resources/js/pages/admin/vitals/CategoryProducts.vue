...
<template>
    <DivTable>
        ...
        <template #tBody>
            <tr v-for="categoryProduct in categoryProducts"
                class="my-1 h-12 border-b border-gray-300 transition-categoryProducts duration-200 hover:bg-gray-200 dark:border-zinc-800 dark:hover:bg-zinc-800"
