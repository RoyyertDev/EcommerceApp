...
<template>
    <button @click="handleClick" class="flex items-center justify-center text-[#DE5976] transition-all duration-300 hover:scale-110">
        <svg
            fill="#DE5976"
            version="1.1"
            id="Capa_1"
            ...
            width="20px"
            height="20px"
            viewBox="-49.49 -49.49 593.92 593.92"
            xml:space="preserve"
            stroke="#DE5976"
            stroke-width="0.00494936"
            transform="rotate(0)"
        >
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#DE5976" stroke-width="9.89872"></g>
